<?php
	...
	if ($_GET['cat'] == 0){ //se for uma requisição de "MINHAS IMAGENS"
		...
		$sql = 'SELECT * FROM imagem WHERE categoria_id = '.($_GET['cat']+132).' and removida = false ORDER BY nome'; //o 132 é para sincronizar com o indice usado pelo scala Android
		$qry = pg_query($sql);
		$i = 0;
