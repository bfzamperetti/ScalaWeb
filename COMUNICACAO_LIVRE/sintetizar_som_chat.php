...
$vetorretirarfrase = array('&nbsp;', '<span style="display: inline-block">');
$frasedigitada= str_replace($vetorretirarfrase, "", $_POST['mensagem']);

$vetora = array("ã", "á", "à");
$frasedigitada=str_replace($vetora, "a", $_POST['mensagem']);
...
$laleli = array($frasedigitada);
//$teste = str_replace("agua", "peter", $teste);
