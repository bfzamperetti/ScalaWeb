<?php include('../INCLUDES/uses.php'); ?>

<form action='teste_nr.php' method='post' >
	<input name='str' type='text' style='width: 500px;' value='<?php if (isset($_POST['str'])) echo $_POST['str']; ?>' />
	<input type='submit' value='vai' />
</form>

<?php
echo urldecode(arrumaSintetizar($_POST['str'])).'<br>';

echo urlencode(arrumaSintetizar($_POST['str'])).'<br>';

echo arrumaSintetizar($_POST['str']);



if (!isset($_POST['str'])) exit;
...
$ds->setInput(array(arrumaSintetizar($_POST['str'])));
